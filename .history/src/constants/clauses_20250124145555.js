...
export const clauses = [
  ...
  // Attendance
  { id: "5.5", name: "Perfect Attendance (Term)", points: [2], category: categories.ATTENDANCE },

  // Music
  { id: "5.6", name: "Music Ensemble/Band Involvement", points: [1], category: categories.MUSIC },

  // Sporting
  { id: "5.7.1", name: "Country Week Participation", points: [1], category: categories.SPORTING },
  { id: "5.7.2", name: "Inter-School Carnival Squad", points: [1], category: categories.SPORTING },

  // Colours Recognition
  { id: "5.8.1", name: "Half Colours", points: [4], category: categories.COLOURS },
  { id: "5.8.2", name: "Full Colours", points: [10], category: categories.COLOURS },
  { id: "5.8.3", name: "Honours", points: [20], category: categories.COLOURS },

  // Wave Award
  { id: "5.9", name: "Wave Award", points: [5], category: categories.WAVE },

  // Special Events
  { id: "5.10", name: "Special Events", points: [], category: categories.SPECIAL },

  // Staff Discretion
  { id: "5.11", name: "Staff Discretion", points: [1, 2, 3], category: categories.OTHER }
];